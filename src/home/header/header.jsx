  ...
  return (
    <header className="flex flex-col header items-center gap-12">
      ...
      <img
        src={HeaderImg}
        alt=""
        className="w-[1216px] h-[169px] pt-[14.78px] pb-[16.08px] justify-center items-center inline-flex"
      />
      <main>
      <section className="sect w-[1440px] h-[550px] bg-black/20 flex aling-center justify-center ">
